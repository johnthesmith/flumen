...
1. [Флюмен-песочница](README.md) описывает наблюдателей:
...
вне контекста любых внутренних правил и ограничений. 

Обозначение `Α`

Он воспринимает систему целиком как абстракцию, оценивает её свойства извне, 
понимает её устройство и функционирование без привязки к локальным измерениям. 
Имеет возможность добавлять и удалять флюмены.
...
Внутренний наблюдатель — устойчивая структура флюменов, как подмножество 
[множества флюменов](./set.md), содержащая в своей топологии частичное отражение 
иных структур на основе квантов информации (память). Наблюдатель является 
причиной последующего распространения информации.
