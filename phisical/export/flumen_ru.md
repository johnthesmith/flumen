...
1.  doi:10.5281/zenodo.14319493
    <https://doi.org/10.5281/zenodo.14319493>
...
1.  флюмен (лат flumen --- поток) --- абстрактная однонаправленная связь
    двух натуральных чисел или индексов (ориентированное ребро графа
    между двумя вершинами).

2.  Обозначается флюмен как  $f_{a,b}$, где $a 
                \in \mathbb{N}$ --- первый индекс, $b \in \mathbb{N}$
    --- второй индекс.

3.  Важно: флюмен, как и ребро графа, не имеет координат и не
    принадлежит какому-либо пространству в традиционном понимании, так
    как $\mathbb{N} \subset \mathbb{R}, \mathbb{N} \neq 
                \mathbb{R}$, а так же $x \in \mathbb{R}, x \notin 
                \mathbb{N}$ , где $x$ некая пространственная координата.

4.  Специфическое наименование введено для отделения восприятия флюмена
    как пространственного кванта от математического понятия ребра графа.
    При этом флюмен является единственным \"строительным\" блоком для
    создания пространственных структур.
